...
<html  dir="ltr" lang="fr" xml:lang="fr">
	<head>
		...
		<script type="text/javascript" src="../JS/script_inscription_connexion.js"></script>
	...
	<body>
		...
		<form method="post" action="connexion.php" onsubmit="return verifie_champs_connexion()">
