<?php
  ...
  function AfficheVictime()
  {
    ...
    if($_COOKIE['Brancard']=="brancardGauche" && $vue1 -> getGauche() != null )
    {
      echo 'Description : '.$vue1 -> getGauche() -> getDescription().'<br/>La personne à '.$vue1 -> getGauche() -> getAge().' ans <br/>Il sagit d un(e) '.$vue1 -> getGauche() -> getSexe().'<br/>Il est dans un état :'.$vue1 -> getGauche() -> getEtat();
    }elseif($_COOKIE['Brancard']=="brancardDroite" && $vue1 -> getDroit() != null )
    {
      echo 'Description : '.$vue1 -> getDroit() -> getDescription().'<br/>La personne à '.$vue1 -> getDroit() -> getAge().' ans <br/>Il sagit d un(e) '.$vue1 -> getDroit() -> getSexe().'<br/>Il est dans un état :'.$vue1 -> getDroit() -> getEtat();
    }
    else{echo "Veuillez attendre l'arrivé de patient";}
